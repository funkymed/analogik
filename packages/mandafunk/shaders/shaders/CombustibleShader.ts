...
export class CombustibleShader extends ShaderAbstract {
    constructor() {
        super()
        ...
        */
        ...
        {
            // Screen coordinates.
            vec2 uv = ((vUv.xy*iResolution.xy) - iResolution.xy*.5) / iResolution.y;
            ...
            gl_FragColor = vec4(sqrt(clamp(col, 0., 1.)), iOpacity);
        }
        `
    }
}
