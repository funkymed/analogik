...
function isSelected(track, selection) {
    if (selection === 'bleep' && track.bleep) {
        return true
    } else if (selection === 'selecta' && !track.bleep) {
        return true
...
export function getTracks(year, author, selection) {
    ...
    for (let track of tracks) {
        if (year || author || selection) {
            ...
            } else if (author && track.author.includes(author)) {
                selectedTracks.push(track)
            } else if (year && track.year === year) {
                selectedTracks.push(track)
            } else if (selection && isSelected(track, selection)) {
                selectedTracks.push(track)
            }
        } else {
            selectedTracks.push(track)
